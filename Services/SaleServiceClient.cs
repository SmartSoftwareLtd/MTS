...
namespace AuctionInventory.Services
{
    public class SaleServiceClient
    {
        ...
        public bool DeleteSalesRecord(long iSaleID, int iSaleFrontEndID)
        {
            bool status = false;
            SaleRepository repo = new SaleRepository();
            status = repo.DeleteSalesRecord(iSaleID,iSaleFrontEndID);
            return status;
        }
        ...
        public dynamic GetPreviousPaymentInfo(int id)
        {
            SaleRepository repo = new SaleRepository();
            dynamic getSalesPaymentlist = repo.GetPreviousPaymentInfo(id);
            return getSalesPaymentlist;
        ...
        private Sale ParserAddSale(SaleModel mSale)
        {
            ...
            if (mSale != null)
            {
                ...
                eSale.dmlParkingFees = mSale.dmlParkingFees;
                eSale.iYardID = mSale.iYardID;
                eSale.iCarStatusID = mSale.iCarStatusID;

                 eSale.strBookingID = mSale.strBookingID;
                 eSale.strVoucherNo = mSale.strVoucherNo;
                 eSale.strReferenceNumber = mSale.strReferenceNumber;
        ...
        private SalesPayment ParserAddSalesPayment(SalesPaymentModel mSalesPayment)
        {
            ...
            if (mSalesPayment != null)
            {
                ...
                eSalesPayment.strReferenceNumber = mSalesPayment.strReferenceNumber;
                eSalesPayment.strDescription = mSalesPayment.strDescription;
                eSalesPayment.ysnPaymentStatusFromSales = mSalesPayment.ysnPaymentStatusFromSales;
