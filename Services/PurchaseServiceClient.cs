...
namespace AuctionInventory.Services
{
    public class PurchaseServiceClient
    {
        ...
        public dynamic GetSupplierInfo(int id)
        {
        ...
        private List<Purchase> ParserGetAllPurchase(dynamic responseData)
        {
            ...
            foreach (var data in responseData)
            {
                if (data != null)
                {
                    ...
                    purchase.iSupplierID = data.iSupplierID;

                    purchase.strCustomerInvoiceNo = data.strCustomerInvoiceNo ?? " ";
        ...
        private Purchase ParserPurchase(dynamic data)
        {
            ...
            if (data != null)
            {
                ...
                purchase.strReferenceNumber = data.strReferenceNumber;
                purchase.strRemark = data.strRemark;
